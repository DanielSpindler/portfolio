...
export default async function Contact() {
  ...
  return (
    <div className="font-sans mx-auto justify-center min-h-screen p-8 pb-20 gap-16 sm:p-20 w-full h-full">
      ...
      <div className="max-w-1/2 mt-4 pb-2 mx-auto bg-red-900/80 rounded-xl hidden sm:flex justify-center">
        {data.joke && (
          <p className="text-lg text-center mt-4 px-2.5 py-2 whitespace-break-spaces">
